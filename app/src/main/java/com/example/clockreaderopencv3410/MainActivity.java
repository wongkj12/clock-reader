...
public class MainActivity extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    //Loads OpenCV, checks if it's connected properly
    ...
    public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
        ...
        if (c != null) {
            ...
            // Adding white circle at the center helps to seperate the clock hand contours
            Imgproc.circle(frame, center, 2, new Scalar(255, 255, 255), 5, 8, 0);
            // circle outline
            ...
            if (c_x - radius >= 0 && c_x + radius <= frame.cols() && c_y - radius >= 0 && c_y + radius <= frame.rows()){
                ...
                //Apply dilation
                //Long and thin kernels helps in filtering the shape of clock hands
                ...
                Imgproc.threshold(gray, threshed, thresh, maxValue, 1);
                ...
                if (contours.size() >= 2) {
                    ...
                    //Imgproc.drawContours(d,contours,0,new Scalar(0,255,0),-1,Core.LINE_8);
                    ...
                    // Determining which rect is minute and hour hand
                    if (R0 >= R1){
                        minute = rect0;
                        hour = rect1;
                    }
                    ...
                    //Calculating time from position of hands
